...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_61(
        ...
        KC_LCTL, KC_LOPT,  KC_LCMD,                            KC_SPC,                             TG(_FN4), TG(_FN5), MO(_FN3), KC_RCTL),
    ...
    [_FN4] = LAYOUT_ansi_61(
        KC_ESC,  KC_1,     KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,
        KC_TAB,  MS_BTN1,  MS_BTN2, MS_WHLU, KC_R,    KC_T,    KC_Y,    KC_U,    MS_UP,   KC_O,    KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,
        KC_CAPS, KC_A,     MS_BTN3, MS_WHLD, KC_F,    KC_G,    KC_H,    MS_LEFT, MS_DOWN, MS_RGHT, KC_SCLN,  KC_QUOT,            KC_ENT,
        KC_LSFT,           MS_ACL0, MS_ACL1, MS_ACL2, KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH,            KC_RSFT,
        KC_LCTL, KC_LOPT,  KC_LCMD,                            KC_SPC,                             TG(_FN4), MO(_FN1), MO(_FN3), KC_RCTL),

    [_FN5] = LAYOUT_ansi_61(
        KC_ESC,  KC_1,     KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,
        KC_TAB,  KC_Q,     KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_UP,   KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,
        KC_CAPS, KC_A,     KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_LEFT, KC_DOWN, KC_RIGHT, KC_SCLN,  KC_QUOT,            KC_ENT,
        KC_LSFT,           KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT,
        KC_LCTL, KC_LOPT,  KC_LCMD,                            KC_SPC,                              TG(_FN4), TG(_FN5), MO(_FN3), KC_RCTL)
};
